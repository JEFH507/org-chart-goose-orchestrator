...
- CE defaults: Keycloak (OIDC), Vault OSS + KMS, Postgres, optional S3-compatible object storage (SeaweedFS default; MinIO/Garage optional), Ollama for guard models (README.md, productdescription.md, ADR 0003).
