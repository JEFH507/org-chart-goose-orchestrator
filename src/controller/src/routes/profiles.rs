...
pub async fn get_profile(
    ...
    // TEMPORARILY DISABLED FOR TESTING - TODO: Fix Vault signing key issue
    ...
    // } else {
        ...
        info!(
            message = "profile.verify.skipped.temporary",
            role = %role,
            "TEMPORARY: Signature verification disabled for MCP testing - will re-enable after Vault fix"
        );
    // }
